...
class FilterDonorsTest extends TestCase
{
     ...
     * @test
     */
    public function it_get_all_donors_filtered_by_township(): void
    {
        $this->withoutExceptionHandling();
        $userOne = User::factory()->create(['township_id' => 1]);
        $userTwo = User::factory()->create(['township_id' => 2]);

        $response = $this->get("/donors?township=1");
