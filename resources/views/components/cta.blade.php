<section class="cta py-5 my-5 bg-dark">
    ...
    <div class="shareBtns container d-flex flex-column flex-sm-row flex-wrap align-items-center justify-content-center">
        ...
        <a
        {{-- href="https://www.facebook.com/sharer/sharer.php?u={{ config('app.url') }}"  --}}
        class="fbShare btn d-flex align-items-center justify-content-center" target="_blank" rel="nofollow">
        ...
        <a
        {{-- href="https://www.facebook.com/dialog/send?link={{ config('app.url') }}&app_id=194134865891187&redirect_uri={{ config('app.url') }}" --}}
        class="messengerShare btn d-flex align-items-center justify-content-center my-3 my-lg-0 mx-sm-3" target="_blank" rel="nofollow">
        ...
        <a
        {{-- href="https://web.whatsapp.com/send?text={{ config('app.url') }}" --}}
        class="whatsappShare btn d-flex align-items-center justify-content-center" target="_blank" rel="nofollow">
